...
export const HeroSection = () => {
  ...
  <div className="col-md-4">
    <img src={Image} alt="Your Alt Text Here" className="img-fluid" style={{ maxWidth: '90%', height: 'auto', marginLeft: '40%' }} />
  </div>
</div>

    
    
            <div style={{marginRight:'7rem', marginLeft:'7rem', marginTop:'2rem', marginBottom:'2rem'}} ><h4>Pinpoint is the fastest tracking and reservation software
                solution for personal and enterprise vehicles for institutes,
                offices and companies with live tracking, history recording,
                estimated arrival time and usage report generation and much more features</h4></div>
